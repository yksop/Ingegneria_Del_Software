...
mongo_db_name = 'test'
mongo_collection_name = 'hospitals'
...
# Read csv file
csv_file_path = 'openDataLoader/data/ospedali.csv'
...
for index, row in df.iterrows():
    ...
    data.append(record)
    print("latitudine:", lat, "longitudine:", lon, "nome:", row['nome'], "tipo:", row['tipo'], "via:", row['via'], "civico:", row['civico'] )
